let tablaData;
let idEditar = 0;
const controlador = "Curso";
const modal = "mdData";
const preguntaEliminar = "¿Desea eliminar el curso?";
const confirmaEliminar = "El curso fue eliminado.";
const confirmaRegistro = "Curso registrado!";
...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    tablaData = $('#tbData').DataTable({
        ...
        "columns": [
            ...
            {
                title: "", "data": "idCurso", width: "100px", render: function (data, type, row) {
...
$("#tbData tbody").on("click", ".btn-eliminar", function () {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch(`/${controlador}/Eliminar?Id=${data.idCurso}`, {
                method: "DELETE",
